...
kmeans_model = joblib.load("UltimateGuitar_clustering.pkl")
tfidf_vectorizer = joblib.load("UltimateGuitar_tfidf_vectorizer.pkl")

# === Set Halaman ===
st.set_page_config(page_title="Topic Clustering - Ultimate Guitar", layout="wide")

# === Judul Aplikasi dengan Emoji Gitar 🎸 ===
st.title("🎸 Topic Clustering - Ultimate Guitar")
    ...
    if file:
        ...
        if not required_cols.issubset(df.columns):
            ...
            st.download_button(
                ...
                file_name="hasil_klaster_ultimate_guitar.csv",
                mime="text/csv"
            )
